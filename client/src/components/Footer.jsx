            ...
            <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div class="md:flex md:justify-between">
                    ...
                    <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4">
                        ...
                        <div>
                            <h2 class="mb-6 text-sm font-semibold text-gray-900 uppercase">Faq</h2>
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">Account</a>
                                </li>
                                <li className='mb-4'>
                                    <a href="#" class="hover:underline">Manage Deliveries</a>
                                </li>
                                <li class="mb-4">
                        ...
                        <div>
                            ...
                            <ul class="text-gray-500 dark:text-gray-400 font-medium">
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">Free eBooks</a>
                                </li>
                                <li className='mb-4'>
                                    <a href="#" class="hover:underline">Development Tutorials</a>
                                </li>
                                <li class="mb-4">
                                    <a href="#" class="hover:underline">How to - Blog</a>
                                </li>
                                <li>
                                    <a href="#" class="hover:underline">Youtube Playlist</a>
                                </li>
                            </ul>
                        </div>
                    </div>
